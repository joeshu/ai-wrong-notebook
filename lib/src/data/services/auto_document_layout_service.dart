...
class AutoDocumentLayoutService implements DocumentLayoutService {
  ...
  Future<LayoutDetectionResult> detectQuestionRegions({required String imagePath}) async {
    ...
    try {
      ...
      final fast = await PaddleCloudDocumentLayoutService(paddleConfig).detectQuestionRegions(imagePath: imagePath);
      ...
      fallbackReason = 'PaddleOCR 未返回可用结果';
    }
    ...
    final precise = await MineruDocumentLayoutService(mineruConfig).detectQuestionRegions(imagePath: imagePath);
